...
const FRAMES = [
  document.querySelector('.sprite.smoke-1'),
  document.querySelector('.sprite.smoke-2'),
  document.querySelector('.sprite.smoke-3'),
  document.querySelector('.sprite.smoke-4'),
  document.querySelector('.sprite.smoke-5'),
  document.querySelector('.sprite.smoke-6'),
]
